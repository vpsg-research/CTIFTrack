...
from lib.models.ctiftrack.vit_cae_async import CAE_Base_patch16_224_Async
...
class CTIFTrack(nn.Module):
    ...
    def forward(self,template_feats, search ):
        ...
        # last_import = self.gdecoder(x,z,previous_features)
    ...
    def forward_head(self, cat_feature,
        ...
        if self.head_type == "CENTER":
            ...
            # cat_feature = torch.cat(cat_feature, dim=1)
...
def build_CTIFTrack(cfg, training=True):
    current_dir = os.path.dirname(os.path.abspath(
        __file__))  # This is your Project Root
    pretrained_path = os.path.join(current_dir, '../../../pretrained_models')
    if cfg.MODEL.PRETRAIN_FILE and ('CTIFTrack' not in cfg.MODEL.PRETRAIN_FILE) and training:
    ...
    if 'ctiftrack' in cfg.MODEL.PRETRAIN_FILE and training:
