...
from lib.models import build_CTIFTrack
...
class CTIFTrack(BaseTracker):
    def __init__(self, params, dataset_name):
        super(CTIFTrack, self).__init__(params)
        network = build_CTIFTrack(params.cfg, training=False)
