...
from lib.models import build_ostrack, build_LiteTrack,build_CTIFTrack
...
def run(settings):
    ...
    elif settings.script_name == "ctiftrack":
        net = build_CTIFTrack(cfg)
    else:
    ...
    qfl = QFL()
    # negL = negL()
    if settings.script_name == "ostrack" or settings.script_name == "litetrack" or settings.script_name== "ctiftrack":
