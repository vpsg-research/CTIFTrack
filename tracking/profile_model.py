...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='ctiftrack', choices=['litetrack'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='B8_cae_center_all_ep300', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    if args.script == "ctiftrack":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_CTIFTrack
        model = model_constructor(cfg, training=False)
